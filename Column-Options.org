...
| editor | null | The editor for cell edits {TextEditor, IntegerEditor, DateEditor...} See [[https://github.com/6pac/SlickGrid/blob/master/slick.editors.js][slick.editors.js]] |
